@echo off
REM neko-auth installer for Windows CMD.
REM
REM   curl -fsSL https://raw.githubusercontent.com/zoefix/neko-auth/main/install.cmd -o install.cmd ^&^& install.cmd
REM
...
set "NEKO_AUTH_PS1=https://raw.githubusercontent.com/zoefix/neko-auth/main/install.ps1"

where powershell >nul 2>&1
if errorlevel 1 (
    echo error: PowerShell was not found on PATH.
    echo Install from https://github.com/zoefix/neko-auth/releases instead.
    exit /b 1
)
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "[Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12; irm '%NEKO_AUTH_PS1%' | iex"
